...
export class PortalSystem{
  ...
  private tp(){
    ...
    const ent=this.inP(A,cx,cy,hw,hh)?A:(this.inP(B,cx,cy,hw,hh)?B:0 as any); if(!ent){ this.last=undefined; return; }
    const ext=ent===A?B:A, b:any=pl.body, lv=tb(b.vel.x,b.vel.y,ent.o), re=fb(-lv.n,lv.t,ext.o),
