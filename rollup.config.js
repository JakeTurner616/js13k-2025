...
export default {
  ...
  output: {
    ...
    compact: true,
    esModule: false,
    // Friendlier shape for post-packers
    generatedCode: { constBindings: false, arrowFunctions: true },
  ...
  plugins: [
    ...
    terser({
      ...
      mangle: {
        toplevel: true,
        properties: {
          // opt-in private prop mangling via leading underscore
          regex: /^_/
        }
      },
      format: {
        comments: false,
        ascii_only: false, // allow non-ASCII if shorter
        semicolons: false
      }
    }),
    copyPublicFolder()
